...
const decodeBase64String = (input) => Buffer.from(input, 'base64').toString('utf8');

const encodeBase64String = (input) => Buffer.from(input, 'utf8').toString('base64');
...
module.exports.decodeBase64String = decodeBase64String;
module.exports.encodeBase64String = encodeBase64String;
